                ...
                <td valign=top align=middle>
					...
					<table id=child2 style="display: none" cellspacing=0 cellpadding=0  width=150 border=0>
						...
						<tr height=20>
                            ...
                            <td>
								<a class=menuchild href="Educational/class/selectallcla" target="right">班级管理</a>
							</td>
						</tr>
						...
						<tr height=20>
                            ...
                            <td>
								<a class=menuchild href="Educational/student/selectall" target="right">学生管理</a>
							</td>
						</tr>
                        ...
                        <tr height=20>
                            ...
                            <td>
								<a class=menuchild  href="Educational/exam/findlist"  target="right">组织考试</a>
							</td>
						</tr>
					...
					<table id=child7 style="display: none" cellspacing=0 cellpadding=0  width=150 border=0>
                    	<tr height=20>
                            ...
                            <td>
								<a class=menuchild  href="power/user/findalluser"  target="right">用户管理</a>
							</td>
						</tr>
