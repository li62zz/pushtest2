...
<div class="cztable">
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td>
				<input type="text" value="${exam.examnum}" readonly"/>
			</td>
        </tr>
		...
		<tr>
            ...
            <td>
				<input type="text" value="<fmt:formatDate value='${exam.examtime}' pattern='yyyy-MM-dd'/>" readonly/>
			</td>
        </tr>
		...
		<tr>
            ...
            <td>
				<input type="text" value="${exam.classes.classname}" readonly />
			</td>
        </tr>
